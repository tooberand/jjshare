        ...
        for line in f_in:
            ...
            if file_section == "details":
                ...
                if m:
                    ...
                    new_line = "Rowing - " + new_total_total + " (" + history
                    if last_month != current_month \
                       or now.strftime("%b%d") == "Jul01":
                        new_line += last_month + "-" + month_total + "/"
                        new_line += current_month + "-" + wo_meters
                    else:
                        new_month_total = str(int(month_total) + int(wo_meters))
                        new_line += last_month + "-" + new_month_total
